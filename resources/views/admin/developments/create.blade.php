    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ __('developments.DEVELOPMENTS_PAGE.ADD') }}
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="mb-0">{{ __('developments.DEVELOPMENTS_PAGE.ADD') }}</h3>
                    </div>
                </div>
                <!--end::Row-->
            </div>
                        ...
                        <form action="{{ route('admin.developments.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="authors" name="authors" class="form-control">{{ old('authors') }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="publications" class="form-label">{{ __('developments.DEVELOPMENTS_MODEL.PUBLICATIONS') }}</label>
                                    <textarea id="publications" name="publications" class="form-control">{{ old('publications') }}</textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="practical_application" name="practical_application" class="form-control">{{ old('practical_application') }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="version_history" class="form-label">{{ __('developments.DEVELOPMENTS_MODEL.VERSION_HISTORY') }}</label>
                                    <textarea id="version_history" name="version_history" class="form-control">{{ old('version_history') }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="demo_videos" class="form-label">{{ __('developments.DEVELOPMENTS_MODEL.DEMO_VIDEOS') }}</label>
                                    <textarea id="demo_videos" name="demo_videos" class="form-control">{{ old('demo_videos') }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="software_link" class="form-label">{{ __('developments.DEVELOPMENTS_MODEL.SOFTWARE_LINK') }}</label>
                                    <textarea id="software_link" name="software_link" class="form-control">{{ old('software_link') }}</textarea>
                                    @error('software_link')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea id="documentation_link" name="documentation_link" class="form-control">{{ old('documentation_link') }}</textarea>
